...
from githubclient.main.utils import sincronize_repositories
            ...
            if search_form.validate_on_submit():
                ...
                repositories = (
                    ...
                    .filter(
                        ...
                        and_(
                            Repository.id_github_account.like(
                                github_account_info_json["id"]
                            )
                        ),
                    )
                ...
                repositories = (
                    Repository.query.filter_by(
                        id_github_account=github_account_info_json["id"]
                    )
